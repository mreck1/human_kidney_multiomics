...
# Figure S12a - Dotplot of cell type markers in the CosMx dataset
...
dotplot + geom_vline(xintercept = 4.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 7.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 9.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 13.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 15.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 17.5, color = "grey10", size=1) + 
  geom_vline(xintercept = 19.5, color = "grey10", size=1) +
