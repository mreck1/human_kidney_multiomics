...
# Figure 21a - Histogram of CUT&RUN peak calling p-values (MACS2)
# JUN
...
# Figure 21c - Fraction of ATAC reads in CUT&RUN peaks along pseudotime
...
# Figure 21d - CUT&RUN TSS enrichment
