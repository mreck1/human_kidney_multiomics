...
# Figure 17b - Genome coverage of CUT&RUN peaks
# JUN
jun_peaks <- readPeakFile(file.path(path, 'jun_peaks.narrowPeak')
...
covplot(jun_peaks, weightCol="V5")
...
covplot(nfkb1_peaks, weightCol="V5")


# Figure 17c - CUT&RUN TSS enrichment
...
# Figure 17f - Fraction of ATAC reads in CUT&RUN peaks along pseudotime
